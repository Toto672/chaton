...
A Chatons extension is a folder containing a manifest (`chaton.extension.json`), HTML, CSS, and JavaScript files. Extensions run inside isolated webview iframes with access to a set of host APIs.

An extension can contribute:

- **Sidebar menu items** and **main views** (full-page UIs)
