          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span className="flex-1 line-clamp-1">
                {t("Erreur lors de la mise à jour")}
              </span>
              <ChevronDown
                className={`h-4 w-4 flex-shrink-0 transition-transform ${showErrorDetails ? "rotate-180" : ""}`}
              />
            </button>
            <button
              type="button"
          ...
          <div className="ml-7 rounded border border-green-200 bg-green-50 p-2 text-sm text-green-700 dark:border-green-900 dark:bg-green-950 dark:text-green-200">
            <p className="break-words">
              ...
              window.desktop?.platform === "darwin"
                ? t(
                    "Le fichier de mise à jour est ouvert. Complétez l'installation dans Finder.",
                  )
                : t(
