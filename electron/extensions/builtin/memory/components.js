const STYLE_ID = "chaton-extension-components-style";
...
function ensureStyles() {
  ...
  style.textContent = [
      ...
      ".ce-shell { background: var(--ce-bg); color: var(--ce-fg); width: 100%; height: 100%; font-family: var(--ce-font); overflow: hidden; }",
      ...
      // Detail pane (right side) - columned iPad-style layout
      ".ce-shell-detail { background: color-mix(in srgb, var(--ce-bg) 99%, white); display: flex; flex-direction: column; padding: 0; position: relative; overflow: hidden; min-height: 0; }",

      // Empty state
      ".ce-shell-empty { display: flex; flex-direction: column; align-items: center; justify-content: center; gap: 16px; color: var(--ce-muted-fg); padding: 40px 20px; flex: 1; }",
      ...
      // Detail content sections (add subtle separation)
      // Summary badges
...
export const chatonExtensionComponents = {
...
if (typeof window !== "undefined") {
  window.chatonExtensionComponents = chatonExtensionComponents;
}
